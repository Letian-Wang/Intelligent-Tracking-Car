...
extern uint8 imgbuff[CAMERA_SIZE],imgbuff_process[CAMERA_SIZE];                       //定义存储接收图像的数组
extern uint8 img[CAMERA_W*CAMERA_H],img_edg[CAMERA_SIZE*2];              
extern uint8 LMR[CAMERA_H][3];
