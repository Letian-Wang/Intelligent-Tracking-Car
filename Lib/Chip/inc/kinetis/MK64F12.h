...
#define MCG_C5_PRDIV(x)  MCG_C5_PRDIV0(x)
/* C6 Bit Fields */
...
#define MCG_C6_VDIV(x)   	MCG_C6_VDIV0(x) 
/* S Bit Fields */
...
typedef struct USB_MemMap {
  ...
  uint8_t CLK_RECOVER_CTRL;                        /**<offset:0x140*/
  uint8_t RESERVED_27[3];
  uint8_t CLK_RECOVER_IRC_EN;                 /**<offset:0x144*/
  uint8_t RESERVED_28[23];
  uint8_t CLK_RECOVER_INT_STAT;/**<offset:0x15C*/
...
#define USB_CLK_RECOVER_INT_STAT_REG(base)             ((base)->CLK_RECOVER_INT_STAT)
...
#define USB_CLK_RECOVER_CTRL_CLOCK_RECOVER_EN_MASK   0x80
#define USB_CLK_RECOVER_CTRL_CLOCK_RECOVER_EN_SHIFT 7
/* CLK_RECOVER_IRC_EN Bit Fields */
#define USB_CLK_RECOVER_IRC_EN_IREC_EN_MASK     0x02u
#define USB_CLK_RECOVER_IRC_EN_IREC_EN_SHIFT    1
#define USB_CLK_RECOVER_IRC_EN_REG_EN_MASK      0x01u
...
#define USB0_CLK_RECOVER_INT_STAT               USB_CLK_RECOVER_INT_STAT_REG(USB0_BASE_PTR)
